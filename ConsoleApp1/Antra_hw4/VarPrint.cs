...
public class VarPrint
{
    public void Print()
    {
        ...
        Console.WriteLine("{0,-10} {1,-20} {2,-30} {3,-40}", "Type", "Bytes", "Min Value", "Max Value");
    ...
    public void PrintTypeInfo<T>(string typeName) where T : struct, IComparable, IFormattable, IConvertible
    {
    ...
    public T GetMinValue<T>() where T : struct, IComparable, IFormattable, IConvertible
    {
